...
Brief.
Manchester City.
We want to improve in the January transfer window. We don't want to add more than one player
as Guardiola fears adding more could upset the balance of the team.
We want a proven talent as we can't afford anything but a top two finish this season.
...
## Striker Player Data
```{r}
player_data_pl <- read_csv("data/england/2020.21.EPL.Meta.csv") %>%
  arrange(desc(goals)) %>%
  head(10)
